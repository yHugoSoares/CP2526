...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{zipWithPlus}\;[\mskip1.5mu \mskip1.5mu]\;\Varid{ys}\mathrel{=}\Varid{ys}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{zipWithPlus}\;\Varid{xs}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Varid{xs}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{zipWithPlus}\;(\Varid{x}\mathbin{:}\Varid{xs})\;(\Varid{y}\mathbin{:}\Varid{ys})\mathrel{=}(\Varid{x}\mathbin{+\!\!+}\Varid{y})\mathbin{:}\Varid{zipWithPlus}\;\Varid{xs}\;\Varid{ys}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bft}\;\Varid{t}\mathrel{=}\anaList{\Varid{geneBFT}}\;[\mskip1.5mu \Varid{t}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{geneBFT}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_1\;(){}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{geneBFT}\;(\Conid{Empty}\mathbin{:}\Varid{ts})\mathrel{=}\Varid{geneBFT}\;\Varid{ts}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{geneBFT}\;(\Conid{Node}\;(\Varid{a},(\Varid{l},\Varid{r}))\mathbin{:}\Varid{ts})\mathrel{=}i_2\;(\Varid{a},\Varid{ts}\mathbin{+\!\!+}[\mskip1.5mu \Varid{l},\Varid{r}\mskip1.5mu]){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Varid{a}\lambda \Varid{times}\;\Conid{Stream}\;\Varid{a}}
\\
    \ensuremath{(\Conid{Stream}\;\Varid{a},\Conid{Stream}\;\Varid{a})}
           \ar[u]^-{\ensuremath{\Varid{fairMerge}}}
           \ar[r]_-{\ensuremath{\Varid{gene}}}
&
    \ensuremath{\Varid{a}\lambda \Varid{times}\;(\Conid{Stream}\;\Varid{a},\Conid{Stream}\;\Varid{a})}
           \ar[u]_-{\ensuremath{\Varid{id}\lambda \Varid{times}\;\Varid{fairMerge}}}
}
\end{eqnarray*}
...
\xymatrix@C=3cm@R=1.5cm{
    \ensuremath{\Conid{S}} 
           \ar[d]_-{\ensuremath{\Varid{mealy}}} 
           \ar[r]^-{\ensuremath{\Varid{g}}} 
& 
    \ensuremath{\Conid{I}\lambda \Varid{to}\;\Conid{O}\lambda \Varid{times}\;\Conid{S}} 
           \ar[d]^{\ensuremath{\Varid{id}\lambda \Varid{to}\;\Varid{id}\lambda \Varid{times}\;\Varid{mealy}}} 
\\
    \ensuremath{\Conid{Mealy}\;\Conid{I}\;\Conid{O}} 
& 
    \ensuremath{\Conid{I}\lambda \Varid{to}\;\Conid{O}\lambda \Varid{times}\;\Conid{Mealy}\;\Conid{I}\;\Conid{O}} 
           \ar[l]^-{\ensuremath{\Varid{inMealy}}}
}
\end{eqnarray*}
...
No contexto da rede viária, modelamos uma avenida onde o estado é a cor do semáforo (\ensuremath{\Conid{Bool}}). O gene $\ensuremath{\Varid{g}}$ dita que, se o semáforo estiver verde (\ensuremath{\Conid{True}}), a entrada de carros é integralmente transferida para a saída. Se estiver vermelho (\ensuremath{\Conid{False}}), a saída é uma lista vazia, simulando a retenção do tráfego. Em cada passo, o estado alterna, garantindo a fluidez alternada do sistema.
...
\column{7}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avenidaMealy}\mathbin{::}\Conid{Bool}\to \Conid{Mealy}\;[\mskip1.5mu \Conid{Carro}\mskip1.5mu]\;[\mskip1.5mu \Conid{Carro}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{avenidaMealy}\mathrel{=}\Varid{anaMealy}\;\Varid{gene}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{gene}\;\Varid{verde}\;\Varid{entrada}\mathrel{=}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\mathbf{if}\;\Varid{verde}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\mathbf{then}\;(\Varid{entrada},\neg \;\Varid{verde}){}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\mathbf{else}\;([\mskip1.5mu \mskip1.5mu],\neg \;\Varid{verde}){}\<[E]%
\\
\>[B]{}\Varid{transitoBraga}\mathbin{::}\Conid{Mealy}\;[\mskip1.5mu \Conid{Carro}\mskip1.5mu]\;[\mskip1.5mu \Conid{Carro}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{transitoBraga}\mathrel{=}\Varid{avenidaMealy}\;\Conid{True}\comp \Varid{avenidaMealy}\;\Conid{False}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
