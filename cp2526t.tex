...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{padd}\;(\Varid{w},\Conid{D}\;\Varid{ms})\mathrel{=}\Conid{D}\;[\mskip1.5mu (\Varid{w}\mathbin{:}\Varid{msg},\mathrm{0.95}\mathbin{*}\Varid{p}),(\Varid{msg},\mathrm{0.05}\mathbin{*}\Varid{p})\mid (\Varid{msg},\Varid{p})\leftarrow \Varid{ms}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
